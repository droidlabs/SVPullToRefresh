  ...
  if([keyPath isEqualToString:@"contentOffset"])
    ...
    switch (self.position) {
      case SVPullToRefreshPositionTop:
        ...
        break;
      case SVPullToRefreshPositionBottom:
        yOrigin = MAX(self.scrollView.contentSize.height, (self.scrollView.bounds.size.height +self.scrollView.bounds.origin.y));
        break;
    }
    ...
    switch (self.position) {
      ...
      case SVPullToRefreshPositionBottom:
        if (self.scrollView.contentSize.height - self.scrollView.bounds.size.height<0){
          scrollOffsetThreshold = MAX(self.scrollView.contentSize.height - self.scrollView.bounds.size.height, 0.0f) + self.bounds.size.height + self.originalBottomInset-self.originalTopInset;
        }
        else{
